...
export const columns = [
    ...
    { name: "NOMBRE(S)", uid: "names" },
    { name: "APELLIDO MATERNO", uid: "firstLastName" },
    { name: "APELLIDO PATERNO", uid: "secondLastName" },
    { name: "MAYORISTA", uid: "isWholeSale" },
    { name: "ACTIONS", uid: "acciones" },
];
...
export default function ClientsTable({ clients, fetchClients }) {
    ...
    const renderCell = React.useCallback((client, columnKey) => {
        ...
        switch (columnKey) {
            ...
            case "secondLastName":
                return (
                    <div className="flex flex-col">
                        <p className="text-bold text-sm capitalize">{(cellValue) ? cellValue : emptyValue}</p>
                    </div>
                );
            case "isWholeSale":
                return (
                    <div className="flex flex-col">
                        <p className="text-bold text-sm capitalize">{(cellValue) ? <FaSquareCheck /> : <FaSquareXmark />}</p>
                    </div>
                );
